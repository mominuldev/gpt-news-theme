...
$sidebar   = Mominul_Theme_Helper::render_sidebars( 'single' );
        ...
        <div class="container <?php echo esc_attr($sidebar_class);  ?>">
            <div class="blog-single-wrapper">
                <div class="row <?php echo apply_filters( 'mominul_row_class', $row_class ); ?>">
                    <div class="col-lg-<?php echo apply_filters( 'mominul_column_class', $column ); ?>">
						...
						if ( mpt_option( 'single_post_nav' ) == true ) {
							Mominul_Theme_Helper::mominul_post_nav();
						}

						if ( mpt_option( 'single_related_post' ) == true ) {
							Mominul_Theme_Helper::related_post();
						}
