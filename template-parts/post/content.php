...
$meta_author_show = pps_option('blog_list_meta_author');
$meta_date_show = pps_option('blog_list_meta_date');
$meta_comment_show = pps_option('blog_list_meta_comment');
$meta_view_count_show = pps_option('blog_list_meta_viewcount');
$meta_comment_show = pps_option( 'blog_list_meta_categories' );
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-post-list entry-post' ); ?>>
        ...
        <div class="pps-blog-content">
            ...
            <div class="entry-content">
                ...
                <div class="read-more">
                    <a href="<?php the_permalink(); ?>" class="pps-btn btn-outline btn-sm"><?php esc_html_e( 'Read More', 'pps-passport' ); ?><i
